...
For a general overview of the submission guideline please refeer to the  \underline{\href{https://wiki.tum.de/display/I6intern/Thesis+Submission+Guidelines}{I6 Wiki}}.

When writing your thesis please use the \code{AIRStudentThesis} template.
...
The main directory of the \code{AIRStudentThesis} template contains two \code{*.tex}: \code{main.tex} and \code{cover.tex}.
