...
\begin{description}
    ...
    \item[Chapter~\ref{ch:experiments}] describes the experimental setup---hardware platform, simulation environment, reward design, and network architectures---presents teacher training results and SafeDAgger distillation experiments, and compares DAgger and SafeDAgger.
